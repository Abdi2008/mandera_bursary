    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav me-auto mb-2 mb-md-0">
          ...
          <li class="nav-item">
            <a class="nav-link active" aria-disabled="false" href="verifier/index.php">University Verifier</a>
          </li>
        </ul>
...
<main>
  ...
  <div id="myCarousel" class="carousel slide mb-6 pointer-event" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <div class="carousel-item">
        <img src="images/young.jpg" class="bd-placeholder-img d-block w-100" alt="University graduation ceremony" style="object-fit:cover;height:520px;">
        <div class="container">
