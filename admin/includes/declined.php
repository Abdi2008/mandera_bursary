	...
	<div class="card-body">
        ...
        <?php 
			...
			<table class="table table-hover table-striped table-bordered" id="list">
				...
				<?php 
					$i = 1;
					$qry = $conn->query("SELECT * from `bursary_application` join students on  bursary_application.student_id=students.student_id join bursary_activity on bursary_application.bursary_id=bursary_activity.bursary_id where a_status='Declined'");
