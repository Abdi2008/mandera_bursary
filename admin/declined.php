	...
	<div class="card-body">
        ...
        <?php 
			...
			<table class="table table-hover table-striped table-bordered" id="list">
				...
				<?php 
					$i = 1;
					$qry = $conn->query("SELECT * from `bursary_application` join students on  bursary_application.student_id=students.student_id join bursary_activity on bursary_application.bursary_id=bursary_activity.bursary_id where given_amount =0.00");
					...
					?>
						<tr>
							...
							<td class=""><?php echo $row['reg_num']; ?></td>
                            <td class=""><?php echo $row['school']; ?></td>
							<td class=""><?php echo $row['period_name']; ?></td>
                            <td class=""><?php echo $row['total_amount']; ?></td>
							<td class=""> 
                                <a class="dropdown-item edit-data" href="declinedDetails.php?student_id=<?php echo $student_id; ?>"><span class="fa fa-edit text-primary"></span> View student Details</a>
                            </td>
						</tr>
					<?php endwhile; ?>
                </tbody>
