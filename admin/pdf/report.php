...
function header(){
          ...
          $this->Cell(276,5,'EVENT CONTRIBUTION LISTS',0,0,'C');
          $this->Ln();
 ...
 function footer(){
  ...
  function ViewTable($db){
      ...
      $stmt=$db->query("SELECT contributions.*, members.email FROM contributions 
      ...
      while($data = $stmt->fetch(PDO::FETCH_OBJ)){
        ...
        $this->Cell(60,10,$data->contribution_date,1,0,'L');
        $this->Ln();
      }
  }
